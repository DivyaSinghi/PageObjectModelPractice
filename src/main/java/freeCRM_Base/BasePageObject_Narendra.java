...
public class BasePageObject_Narendra {
	...
	public BasePageObject_Narendra(WebDriver driver,ExtentTest test){
		this.driver=driver;
		this.test=test;
	...
	public void clickOnElement(By locator,String wantToHighlight){
		...
		if(wantToHighlight.equalsIgnoreCase("Yes")){
			Utility.JavaScriptMethods.highlightElement(driver, elm);
		}
		elm.click();
	}
	...
	public void clickUsingJavaScriptExecutor(By locator,String wantToHighlight){
		...
		Utility.JavaScriptMethods.clickUsingJavaScript(driver, elm);
	}
